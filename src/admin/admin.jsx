...
export default function Admin() {
  ...
  useEffect(() => {
    ...
    // Load mock users (in production, fetch from API)
    const mockUsers = [
      { id: 1, name: "John Doe", email: "john@example.com", role: "user", joinedDate: "Jan 15, 2024", totalOrders: 5 },
      { id: 2, name: "Jane Smith", email: "jane@example.com", role: "user", joinedDate: "Feb 10, 2024", totalOrders: 3 },
      { id: 3, name: "Mike Wilson", email: "mike@example.com", role: "user", joinedDate: "Mar 05, 2024", totalOrders: 8 }
    ];
    setUsers(mockUsers);
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {users.map((user) => (
                      <tr key={user.id} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center">
                              <span className="font-semibold text-orange-600">{user.name.charAt(0)}</span>
                            </div>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900 font-medium">{getUserOrders(user.email).length}</td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-[90%] max-w-3xl max-h-[80vh] overflow-hidden">
            <div className="bg-orange-500 px-6 py-4 flex items-center justify-between">
              <h3 className="text-white text-xl font-bold">{selectedUser.name}'s Orders</h3>
              <button
